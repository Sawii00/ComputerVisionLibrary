...
namespace morph {
	...
	int erode(RGBImage& image, uint8_t kernel_size = 3)
	{
	...
	int erode(HSLImage& image, uint8_t kernel_size = 3)
	{
		//check if it's binary and kernel_size is odd
	...
	int dilate(RGBImage& image, uint8_t kernel_size = 3)
	{
		//check if it's binary and kernel_size is odd
	...
	int dilate(HSLImage& image, uint8_t kernel_size = 3)
	{
		//check if it's binary and kernel_size is odd
	...
	int close(RGBImage& image, uint8_t kernel_size = 3)
	{
		return dilate(image, kernel_size) && erode(image, kernel_size);
	}
	
	int open(RGBImage& image, uint8_t kernel_size = 3)
	{
		return erode(image, kernel_size) && dilate(image, kernel_size);
	}
	
	int close(HSLImage& image, uint8_t kernel_size = 3)
	{
		return dilate(image, kernel_size) && erode(image, kernel_size);
	}
	
	int open(HSLImage& image, uint8_t kernel_size = 3)
	{
		return erode(image, kernel_size) && dilate(image, kernel_size);
	}
