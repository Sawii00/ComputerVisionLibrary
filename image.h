...
- finish is excluded
*/
	static void thread_operation_h(SeparableFilter* horizontal, Pixel* buffer, uint32_t start, uint32_t finish, Image* im) {
...
- finish is excluded
*/
	static void thread_operation_v(SeparableFilter* vertical, Pixel* buffer, uint32_t start, uint32_t finish, Image* im) {
...
2) Horizontal component goes second
*/
	void convolveThreading(SeparableFilter& vertical, SeparableFilter& horizontal) {
		uint32_t first_h;
		uint32_t other_h;
		...
		std::thread t1(Image::thread_operation_h, &horizontal, buffer, 0, first_h, this);
		std::thread t2(Image::thread_operation_h, &horizontal, buffer, first_h, first_h + other_h, this);
		std::thread t3(Image::thread_operation_h, &horizontal, buffer, first_h + other_h, first_h + other_h * 2, this);
		std::thread t4(Image::thread_operation_h, &horizontal, buffer, first_h + other_h * 2, this->h, this);
		...
		std::thread t5(Image::thread_operation_v, &vertical, buffer, 0, first_h, this);
		std::thread t6(Image::thread_operation_v, &vertical, buffer, first_h, first_h + other_h, this);
		std::thread t7(Image::thread_operation_v, &vertical, buffer, first_h + other_h, first_h + other_h * 2, this);
		std::thread t8(Image::thread_operation_v, &vertical, buffer, first_h + other_h * 2, this->h, this);
